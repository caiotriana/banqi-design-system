import{j as a}from"./jsx-runtime-D_zvdyIk.js";import{r as u}from"./index-wjN1KwZK.js";import{r as G,d as p,u as I,w as i,q as j,s as h,V as c,T as C}from"./base-m3uPMzji.js";import{u as X}from"./ThemeProvider-D24FPcro.js";import{A as f}from"./Animated-CWQe7C5U.js";import{M as J}from"./index-N69qlPG8.js";import"./extends-CF3RwP-h.js";import"./index-Dg8UTxH2.js";const O=j.x6,L=G.x2,P=j.x4;function K(e,o,t,n,r){return t?{boxBg:o?e.surface.common.disabled:e.surface.default,boxBorderColor:o?e.surface.common.disabled:e.stroke.common.disabled,boxBorderWidth:p.quarter,checkmarkColor:null,overlayColor:null,labelColor:e.content.common.disabled,hasShadow:!1}:r?{boxBg:o?e.surface.accent.primary:e.surface.default,boxBorderColor:"transparent",boxBorderWidth:p.none,checkmarkColor:o?e.content.common.onColor:e.content.accent.primary,overlayColor:e.surface.common.pressed,labelColor:e.content.default,hasShadow:!0}:n?{boxBg:o?e.surface.accent.primary:e.surface.default,boxBorderColor:e.stroke.accent.primary,boxBorderWidth:p.quarter,checkmarkColor:o?e.content.common.onColor:e.content.accent.primary,overlayColor:e.surface.common.hover,labelColor:e.content.default,hasShadow:!0}:{boxBg:o?e.surface.accent.primary:e.surface.default,boxBorderColor:o?e.stroke.accent.primary:e.stroke.default,boxBorderWidth:p.quarter,checkmarkColor:o?e.content.common.onColor:null,overlayColor:null,labelColor:e.content.default,hasShadow:!0}}const m=I.create({container:{flexDirection:"row",alignItems:"center",gap:j.x2,alignSelf:"flex-start"},shadowWrapper:{alignSelf:"flex-start",borderRadius:L},box:{width:O,height:O,borderRadius:L,overflow:"hidden",alignItems:"center",justifyContent:"center"},iconContainer:{width:P,height:P,alignItems:"center",justifyContent:"center"},overlay:{...I.absoluteFillObject},label:{fontFamily:i.fontFamily,fontWeight:"400",fontSize:i.fontSize.x3_5,lineHeight:i.lineHeight.x5,includeFontPadding:!1}});function ee({color:e}){return a.jsx(c,{style:{width:11,height:6,borderLeftWidth:2,borderBottomWidth:2,borderColor:e,transform:[{rotate:"-45deg"}],marginTop:-2}})}function b({checked:e=!1,onChange:o,label:t,disabled:n=!1,accessibilityLabel:r,testID:s}){const{theme:d}=X(),S=u.useRef(new f.Value(1)).current,[v,B]=u.useState(!1),[w,W]=u.useState(!1),l=K(d,e,n,v,w);function Z(){return w?-1.5:v?h.axis.third:h.axis.quarter}function $(){W(!0),f.spring(S,{toValue:.95,useNativeDriver:!0,speed:50,bounciness:0}).start()}function Q(){W(!1),f.spring(S,{toValue:1,useNativeDriver:!0,speed:50,bounciness:2}).start()}function Y(){n||o==null||o(!e)}return a.jsxs(J,{onPress:Y,onPressIn:n?void 0:$,onPressOut:n?void 0:Q,onHoverIn:n?void 0:()=>B(!0),onHoverOut:()=>B(!1),disabled:n,accessible:!0,accessibilityRole:"checkbox",accessibilityLabel:r??t,accessibilityState:{checked:e,disabled:n},testID:s,style:m.container,children:[a.jsx(f.View,{style:[m.shadowWrapper,{transform:[{scale:S}]},l.hasShadow&&{shadowColor:d.elevation.default,shadowOffset:{width:h.axis.none,height:Z()},shadowOpacity:1,shadowRadius:h.blur.none,elevation:w?1:v?4:2}],children:a.jsxs(c,{style:[m.box,{backgroundColor:l.boxBg,borderColor:l.boxBorderColor,borderWidth:l.boxBorderWidth}],children:[l.checkmarkColor!=null&&a.jsx(c,{style:m.iconContainer,children:a.jsx(ee,{color:l.checkmarkColor})}),l.overlayColor!=null&&a.jsx(c,{style:[m.overlay,{backgroundColor:l.overlayColor,borderRadius:L}],pointerEvents:"none"})]})}),t!=null&&a.jsx(C,{style:[m.label,{color:l.labelColor}],numberOfLines:1,children:t})]})}b.__docgenInfo={description:`Checkbox — componente de seleção binária.
...
`}}},argTypes:{checked:{control:"boolean",table:{defaultValue:{summary:"false"}}},disabled:{control:"boolean",table:{defaultValue:{summary:"false"}}},label:{control:"text"},onChange:{table:{disable:!0}}},args:{checked:!0,disabled:!1,label:"Label",accessibilityLabel:"Checkbox"}},x={name:"Playground",render:e=>{const[o,t]=u.useState(e.checked??!0);return a.jsx(b,{...e,checked:o,onChange:t})}},g={name:"Without Label",args:{label:void 0},parameters:{docs:{description:{story:"Apenas o quadrado 24×24, sem label."}}},render:e=>{const[o,t]=u.useState(!0);return a.jsx(b,{...e,checked:o,onChange:t})}},T=[{label:"Enabled / Unchecked",checked:!1,disabled:!1},{label:"Enabled / Checked",checked:!0,disabled:!1},{label:"Disabled / Unchecked",checked:!1,disabled:!0},{label:"Disabled / Checked",checked:!0,disabled:!0}];function V({text:e}){const{theme:o}=X();return a.jsx(C,{style:{fontFamily:i.fontFamily,fontSize:i.fontSize.x3,fontWeight:"600",color:o.content.subtle,textTransform:"uppercase",letterSpacing:.4,marginBottom:8,width:160},children:e})}const y={name:"All States",parameters:{docs:{description:{story:"Todas as combinações de estado × seleção, com e sem label."}}},render:()=>{const[e,o]=u.useState(Object.fromEntries(T.map((t,n)=>[n,t.checked])));return a.jsxs(c,{style:{padding:16,gap:20},children:[a.jsx(C,{style:{fontFamily:i.fontFamily,fontSize:i.fontSize.x3,fontWeight:"700",marginBottom:4},children:"With Label"}),T.map((t,n)=>a.jsxs(c,{style:{flexDirection:"row",alignItems:"center",gap:16},children:[a.jsx(V,{text:t.label}),a.jsx(b,{checked:t.disabled?t.checked:e[n],onChange:r=>o(s=>({...s,[n]:r})),label:"Label",disabled:t.disabled,accessibilityLabel:t.label})]},n)),a.jsx(C,{style:{fontFamily:i.fontFamily,fontSize:i.fontSize.x3,fontWeight:"700",marginTop:8,marginBottom:4},children:"Without Label"}),T.map((t,n)=>a.jsxs(c,{style:{flexDirection:"row",alignItems:"center",gap:16},children:[a.jsx(V,{text:t.label}),a.jsx(b,{checked:t.disabled?t.checked:e[n],onChange:r=>o(s=>({...s,[n]:r})),disabled:t.disabled,accessibilityLabel:t.label})]},`nl-${n}`))]})}},k={name:"Interactive List",parameters:{docs:{description:{story:"Exemplo de uso real: lista de opções com checkboxes independentes."}}},render:()=>{const e=["Transferência","Pix","Boleto","Cartão de crédito"],[o,t]=u.useState(new Set([0]));function n(r){t(s=>{const d=new Set(s);return d.has(r)?d.delete(r):d.add(r),d})}return a.jsx(c,{style:{padding:16,gap:12},children:e.map((r,s)=>a.jsx(b,{checked:o.has(s),onChange:()=>n(s),label:r,accessibilityLabel:r},r))})}};var E,D,F;x.parameters={...x.parameters,docs:{...(E=x.parameters)==null?void 0:E.docs,source:{originalSource:`{
  name: 'Playground',
  render: args => {
