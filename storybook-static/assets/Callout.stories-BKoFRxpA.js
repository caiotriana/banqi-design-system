...
}`,...(P=(O=p.parameters)==null?void 0:O.docs)==null?void 0:P.source}}};var k,R,V;f.parameters={...f.parameters,docs:{...(k=f.parameters)==null?void 0:k.docs,source:{originalSource:`{
  name: 'All Variants',
  parameters: {
    docs: {
      description: {
