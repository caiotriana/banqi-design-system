import{j as s}from"./jsx-runtime-D_zvdyIk.js";import{r as i}from"./index-wjN1KwZK.js";import{r as U,d as b,v as I,x as l,t as R,s as m,V as d,T as h}from"./base-DPM9NSJ_.js";import{u as X}from"./ThemeProvider-D24FPcro.js";import{A as f}from"./Animated-CZFtwW3c.js";import{M as J}from"./index-BOkGXpOT.js";import"./extends-CF3RwP-h.js";import"./index-BkewXaNL.js";const P=R.x6,B=U.full,k=R.x4;function K(e,o,t,a,r){return t?{boxBg:e.surface.default,boxBorderColor:e.stroke.common.disabled,boxBorderWidth:b.quarter,dotColor:null,overlayColor:null,labelColor:e.content.common.disabled,hasShadow:!1}:r?{boxBg:o?e.surface.accent.primarySubtle:e.surface.default,boxBorderColor:o?e.stroke.accent.primary:e.stroke.default,boxBorderWidth:b.quarter,dotColor:e.content.accent.primary,overlayColor:e.surface.common.pressed,labelColor:e.content.default,hasShadow:!0}:a?{boxBg:o?e.surface.accent.primarySubtle:e.surface.default,boxBorderColor:o?e.stroke.accent.primary:e.stroke.default,boxBorderWidth:b.quarter,dotColor:e.content.accent.primary,overlayColor:e.surface.common.hover,labelColor:e.content.default,hasShadow:!0}:{boxBg:o?e.surface.accent.primarySubtle:e.surface.default,boxBorderColor:o?e.stroke.accent.primary:e.stroke.default,boxBorderWidth:b.quarter,dotColor:o?e.content.accent.primaryPersistent:null,overlayColor:null,labelColor:e.content.default,hasShadow:!0}}const u=I.create({container:{flexDirection:"row",alignItems:"center",gap:R.x2,alignSelf:"flex-start"},shadowWrapper:{alignSelf:"flex-start",borderRadius:B},box:{width:P,height:P,borderRadius:B,overflow:"hidden",alignItems:"center",justifyContent:"center"},dot:{width:k,height:k,borderRadius:U.full,zIndex:1},overlay:{...I.absoluteFill},label:{fontFamily:l.fontFamily,fontWeight:"400",fontSize:l.fontSize.x3_5,lineHeight:l.lineHeight.x5,includeFontPadding:!1}});function c({selected:e=!1,onChange:o,label:t,disabled:a=!1,accessibilityLabel:r,testID:p}){const{theme:W}=X(),v=i.useRef(new f.Value(1)).current,[C,j]=i.useState(!1),[w,L]=i.useState(!1),n=K(W,e,a,C,w);function Z(){return w?-1.5:C?m.axis.third:m.axis.quarter}function $(){L(!0),f.spring(v,{toValue:.95,useNativeDriver:!0,speed:50,bounciness:0}).start()}function Q(){L(!1),f.spring(v,{toValue:1,useNativeDriver:!0,speed:50,bounciness:2}).start()}function Y(){a||o==null||o(!e)}return s.jsxs(J,{onPress:Y,onPressIn:a?void 0:$,onPressOut:a?void 0:Q,onHoverIn:a?void 0:()=>j(!0),onHoverOut:()=>j(!1),disabled:a,accessible:!0,accessibilityRole:"radio",accessibilityLabel:r??t,accessibilityState:{checked:e,disabled:a},testID:p,style:u.container,children:[s.jsx(f.View,{style:[u.shadowWrapper,{transform:[{scale:v}]},n.hasShadow&&{shadowColor:W.elevation.default,shadowOffset:{width:m.axis.none,height:Z()},shadowOpacity:1,shadowRadius:m.blur.none,elevation:w?1:C?4:2}],children:s.jsxs(d,{style:[u.box,{backgroundColor:n.boxBg,borderColor:n.boxBorderColor,borderWidth:n.boxBorderWidth}],children:[n.dotColor!=null&&s.jsx(d,{style:[u.dot,{backgroundColor:n.dotColor}]}),n.overlayColor!=null&&s.jsx(d,{style:[u.overlay,{backgroundColor:n.overlayColor,borderRadius:B}],pointerEvents:"none"})]})}),t!=null&&s.jsx(h,{style:[u.label,{color:n.labelColor}],numberOfLines:1,children:t})]})}c.__docgenInfo={description:`Radio — componente de seleção exclusiva.
...
}`,...(A=(F=g.parameters)==null?void 0:F.docs)==null?void 0:A.source}}};var q,_,H;x.parameters={...x.parameters,docs:{...(q=x.parameters)==null?void 0:q.docs,source:{originalSource:`{
  name: 'All States',
  parameters: {
    docs: {
      description: {
