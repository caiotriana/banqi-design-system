    ...
    return <View style={{
      ...
      padding: 16
        ...
        alignItems: 'center'
          ...
          }}>João da Silva</Text>\r
            <Text style={{
            fontFamily: typography.fontFamily,
            fontSize: 14,
            color: theme.content.subtle
          }}>joao.silva@email.com</Text>\r
          </View>\r
        </View>\r
\r
        {[{
