import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{d as s,r as D,t as c,v as F,s as g,V as a,T as z,x as l}from"./base-DPM9NSJ_.js";import{r as T}from"./index-wjN1KwZK.js";import{u as V}from"./ThemeProvider-D24FPcro.js";import{A as y}from"./Animated-CZFtwW3c.js";import{M as ae}from"./index-BOkGXpOT.js";import"./extends-CF3RwP-h.js";import"./index-BkewXaNL.js";function te(n,o,r){return r?{backgroundColor:o.surface.common.disabled,iconColor:o.content.common.disabled,borderColor:"transparent",borderWidth:s.none}:{primary:{backgroundColor:o.surface.accent.primaryPersistent,iconColor:o.content.common.onColor,borderColor:"transparent",borderWidth:s.none},secondary:{backgroundColor:o.surface.accent.primarySubtleOnSubtle,iconColor:o.content.accent.primaryPersistent,borderColor:o.stroke.default,borderWidth:s.quarter},ghost:{backgroundColor:o.surface.common.ghost,iconColor:o.content.accent.primaryPersistent,borderColor:"transparent",borderWidth:s.none},"ghost-oncolor":{backgroundColor:o.surface.common.ghost,iconColor:o.content.common.onColor,borderColor:"transparent",borderWidth:s.none},oncolor:{backgroundColor:o.surface.common.onColor,iconColor:o.content.accent.primaryPersistent,borderColor:"transparent",borderWidth:s.none},critical:{backgroundColor:o.surface.feedback.critical,iconColor:o.content.common.onColor,borderColor:"transparent",borderWidth:s.none},"ghost-critical":{backgroundColor:o.surface.common.ghost,iconColor:o.content.feedback.critical,borderColor:"transparent",borderWidth:s.none}}[n]}function se(n){return n==="small"?{dimension:c.x5+c.x2*2,borderRadius:D.x3}:{dimension:c.x5+c.x3*2,borderRadius:D.x4}}const d=F.create({wrapper:{alignSelf:"flex-start"},pressable:{alignItems:"center",justifyContent:"center",overflow:"hidden"},iconContainer:{width:c.x5,height:c.x5,alignItems:"center",justifyContent:"center"},overlay:{...F.absoluteFill}}),ie=new Set(["ghost","ghost-oncolor","ghost-critical"]);function i({variant:n="primary",size:o="medium",disabled:r=!1,onPress:t,icon:w,accessibilityLabel:X,testID:Z}){const{theme:u}=V(),S=T.useRef(new y.Value(1)).current,[I,R]=T.useState(!1),[B,L]=T.useState(!1),j=te(n,u,r),{dimension:p,borderRadius:f}=se(o),ee=!r&&!ie.has(n);function oe(){return B?-1.5:I?g.axis.third:g.axis.quarter}function ne(){L(!0),y.spring(S,{toValue:.95,useNativeDriver:!0,speed:50,bounciness:0}).start()}function re(){L(!1),y.spring(S,{toValue:1,useNativeDriver:!0,speed:50,bounciness:2}).start()}return e.jsx(y.View,{style:[d.wrapper,{width:p,height:p,borderRadius:f,transform:[{scale:S}]},ee&&{shadowColor:u.elevation.default,shadowOffset:{width:g.axis.none,height:oe()},shadowOpacity:1,shadowRadius:g.blur.none,elevation:B?1:I?4:2}],children:e.jsx(ae,{onPress:r?void 0:t,onPressIn:r?void 0:ne,onPressOut:r?void 0:re,onHoverIn:r?void 0:()=>R(!0),onHoverOut:()=>R(!1),disabled:r,accessible:!0,accessibilityRole:"button",accessibilityLabel:X,accessibilityState:{disabled:r},testID:Z,style:[d.pressable,{width:p,height:p,borderRadius:f,backgroundColor:j.backgroundColor,borderColor:j.borderColor,borderWidth:j.borderWidth}],children:({pressed:A})=>e.jsxs(e.Fragment,{children:[A&&!r&&e.jsx(a,{style:[d.overlay,{backgroundColor:u.surface.common.pressed,borderRadius:f}],pointerEvents:"none"}),I&&!A&&!r&&e.jsx(a,{style:[d.overlay,{backgroundColor:u.surface.common.hover,borderRadius:f}],pointerEvents:"none"}),e.jsx(a,{style:d.iconContainer,children:w})]})})})}i.__docgenInfo={description:`IconButton — botão de ação com ícone centrado.
...
}`,...(U=(K=C.parameters)==null?void 0:K.docs)==null?void 0:U.source}}};const he=["Playground","DisabledState","OnColorBackground","CriticalVariants","FullMatrix"];export{v as CriticalVariants,h as DisabledState,C as FullMatrix,x as OnColorBackground,b as Playground,he as __namedExportsOrder,be as default};
